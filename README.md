...
Тести можна запускати з IntelliJ IDEA
(ПКМ по файлу FlowerParsersTest.java → Run 'FlowerParsersTest').

Як запустити програму

Відкрити проєкт у IntelliJ IDEA.

Переконатися, що встановлений JDK 17.

Запустити клас Main.java (зелена кнопка Run).

У консолі буде:

результат валідації XML;

вивід квітів, розпарсених DOM, SAX та StAX;

відсортовані списки для DOM;

повідомлення про створення HTML-файлу flowers.html в корені проєкту.

HTML-звіт можна відкрити у браузері.
